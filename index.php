...
$golpeConArma =  SkillManager::create('Golpe con Arma', 'El personaje ataca inflingiendo el 100% del daño de arma si esta es de mano derecha o dos manos, pero de ser de mano izquierda inflingirá 70%', 'fisico','basico', array("damageWeapon" => 1, "damageLeft"=>0.7));

$golpeTrampero =  SkillManager::create('Golpe Trampero', 'El personaje distrae a su oponente con un movimiento malintencionado asestando un golpe con arma que inflije 150% de daño con ambas armas', 'fisico','picaro', array("damageWeapon"=>1.5));

$tajoMortal =  SkillManager::create('Tajo Mortal', 'El personaje salta con intenciones despiadadas y raja a su enemigo inflingiendo 200% de daño con armas.', 'fisico','guerrero', array("damageWeapon" => 2,));
...
$calcinacion =  SkillManager::create('Calcinación', 'El personaje invoca el poder arcano y el elemento del fuego para quemar a su enemigo inflingiendo 40% de su intelecto como daño mágico.', 'magico','mago', array("magicDamage" => 1.4,));
...
echo $orc->getWeapons()[0]->getName()."<br>";
echo $orc->getWeapons()[1]->getName()."<br>";
